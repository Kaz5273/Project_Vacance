...
{
    #[Route('/visite', name: 'app_destination_visite', methods: ['GET', 'POST'])]
    public function Visite(DestinationRepository $destinationRepository, ReviewRepository $reviewRepository): Response
    {


        return $this->render('destination/visite.html.twig', [
